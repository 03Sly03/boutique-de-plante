...
function App() {
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/plantList')
  ...
  return (
    <div>
      ...
      <div className='shop'>
        ...
        <ShoppingList cart={cart} updateCart={updateCart} addToCart={addToCart} sortByCategory={sortByCategory} plants={plants} addCategoryToShop={addCategoryToShop} categories={categories} />
      </div>
      <QuestionForm />
